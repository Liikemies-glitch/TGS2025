    ...
    return (
        ...
        >
            <div
                ...
                <div className="w-[35rem] h-[80rem] -translate-y-87.5 absolute left-0 top-0 -rotate-45 rounded-full bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,hsla(0,0%,90%,.15)_0,hsla(0,0%,65%,.06)_50%,hsla(0,0%,45%,0)_80%)]" />
                <div className="h-[80rem] absolute left-0 top-0 w-56 -rotate-45 rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,hsla(0,0%,90%,.12)_0,hsla(0,0%,55%,.04)_80%,transparent_100%)] [translate:5%_-50%]" />
                <div className="h-[80rem] -translate-y-87.5 absolute left-0 top-0 w-56 -rotate-45 bg-[radial-gradient(50%_50%_at_50%_50%,hsla(0,0%,88%,.08)_0,hsla(0,0%,52%,.03)_80%,transparent_100%)]" />
            </div>
                    ...
                    <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
                        <div className="mx-auto max-w-lg text-left lg:ml-0 lg:w-[70%] lg:max-w-none">
                            ...
                            >
                                ...
                                <h1 className="text-4xl font-medium tracking-tight md:text-5xl lg:text-6xl xl:text-7xl">DIY got you here. <span className="text-brand-blue dark:text-brand-blue-light">Strategic design</span> gets you further.</h1>
